...
public class Options {
  ...
  public static final String PASSWORD_EXTREME_LENGTH_WARNING = "pw.warning.extremelength.message";
  public static final String PASSPHRASE_EXTREME_LENGTH_WARNING = "pp.warning.extremelength.message";
  public static final String PASSPHRASE_LENGTH_WARNING = "pp.warning.length.message";
  public static final String PASSWORD_LENGTH_WARNING = "pw.warning.length.message";
  public static final String OPTIONS_CONFLICT_WARNING = "opts.conflict.warning.message";
  ...
  static HashMap<String, Object> getOptions(String[] args) {
    ...
    try {
      ...
      for (Option option : cmdLine.getOptions()) {
        ...
        if (map.containsKey("m")) {
          if (length < 5) { // Password
            System.out.println("pw.warning.length.message");
          }
          if (length > 16) {
            System.out.println("pw.warning.extremelength.message");
          } else { // passphrase
            if (length < 5) {
     ...
     // Display error and usage.
      ...
      // TODO handle this exception with a usage display.  Display error and usage.
      return null;
    } catch (MissingResourceException ex) {
