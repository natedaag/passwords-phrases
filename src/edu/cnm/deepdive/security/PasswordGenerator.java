...
/**
 * Implementation of a <em>simple</em> password generator. This includes support for
 * elementary character-set-based rules, but not (yet) regular expressions.
 * 
 * @author natedaag
 * @version 1.0
 */
public class PasswordGenerator {
	...
	private static final String AMBIGUOUS = "[O1]";
